...
class ProjectManager {
    ...
    @Todo(task = "Implement user login", assignedTo = "Aditya", priority = "HIGH")
    public void feature1() {
        System.out.println("Feature 1 (Login) is pending.");
    }

    @Todo(task = "Add profile picture upload", assignedTo = "Yash", priority = "LOW")
    public void feature2() {
        System.out.println("Feature 2 (Profile Picture Upload) is pending.");
    }

    @Todo(task = "Integrate payment gateway", assignedTo = "Anirudh")
