...
public class ResumeScreeningSystem {
    public static void main(String[] args) {
        ...
        productResumes.addResume(new ProductManager("Suresh", "Agile, Roadmaps, Market Analysis"));
        productResumes.addResume(new ProductManager("Mukesh", "Product Strategy, UX Research, Stakeholder Management"));
